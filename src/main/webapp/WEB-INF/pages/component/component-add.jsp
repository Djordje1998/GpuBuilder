                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="panel panel-login">
                            <div class="panel-heading">
                                <div class="row">
                                    <h1 class="text-uppercase text-center mb-5">Add new component</h1>
                                </div>
                                <hr>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <form:form action="/pcbuilder/component/save" method="post" modelAttribute="componentDto" class="form-horizontal">
                                            <table class="table">
                                                <div class="form-group">
                                                    <label for="componentName" class="col-sm-4 control-label">Name</label>
                                                    <div class="col-sm-6">
                                                        <form:input id="componentName" class="form-control" type="text" name="componentName" path="componentName" placeholder="Name input ..."/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <form:select id="componentTypeSelect" class="form-control" path="componentType.typeId">
                                                ...
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <form:input id="frequency" class="form-control" type="text" name="frequency" path="frequency" placeholder="Frequency input ..."/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <form:textarea id="description" class="form-control" name="description" path="description" rows="4" cols="20" placeholder="Descripton input ..."/> 
                                                ...
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <form:input id="price" class="form-control" type="text" name="price" path="price" placeholder="Price input ..."/>
                                                ...
                                                <div class="form-group text-center" >
                                                    ...
                                                    <button class="btn btn-success col-sm-5"><i class="glyphicon glyphicon-floppy-save"></i> Save Component</button>
                                                </div>
                                            </form:form>
                                    </div>
                                </div>
