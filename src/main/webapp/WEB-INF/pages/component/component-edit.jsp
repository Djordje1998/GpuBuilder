                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="panel panel-login">
                            <div class="panel-heading">
                                <div class="row">
                                    <h1 class="text-uppercase text-center mb-5">Edit Component</h1>
                                </div>
                                <hr>
                            </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <form:form action="/pcbuilder/component/update" method="post" modelAttribute="componentDto" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <form:select  readonly="true" id="componentTypeSelect" class="form-control" path="componentType.typeId">
