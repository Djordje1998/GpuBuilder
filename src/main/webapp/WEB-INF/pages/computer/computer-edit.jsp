                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="panel panel-login">
                            <div class="panel-heading">
                                <div class="row">
                                    <h1 class="text-uppercase text-center mb-5">Edit Computer</h1>
                                </div>
                                <hr>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <form:form action="/pcbuilder/computer/update" method="post" modelAttribute="computerDto" class="form-horizontal">
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-sm-5">
                                                    <form:input  readonly="true" id="totalPrice" class="form-control" type="text" name="totalPrice" path="totalPrice"/>
                                            ...
                                            <div class="form-group text-center" >
                                                ...
                                                <button class="btn btn-success col-sm-6"><i class="glyphicon glyphicon-floppy-save"></i> Update Computer</button>
                                            </div>
